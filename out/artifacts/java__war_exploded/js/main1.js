...
;(function(window) {
	...
	function selectSeat(planseat) {
		...
		if( classie.has(planseat, 'row__seat--selected') ) {
			...
			var seat1 = seats[planseats.indexOf(planseat)];
			var q1= seat1.getAttribute("data-seat");
			...
			console.log(myArray);
			sessionStorage.setItem("test",Array);
			sessionStorage.setItem("test1",myArray);
			return false;
		}
		...
		var q= seat.getAttribute("data-seat");
		console.log(seat);
		Array = [];
		flag1 = flag1+1;
		Array.push(flag1);
